...
export class AdmTraduccionService {

  private BaseURL = 'adm-traducciones/';
  ...
  form: FormGroup = new FormGroup({
    IdTraduccion: new FormControl(null),
    Tabla: new FormControl(null),
    IdTabla: new FormControl(null),
  ...
  get(Tabla: string, IdTabla: number): Observable<any> {
    ...
    return this.httpClient
      .get<any>(
        this.CONSTANS.getApiUrl(this.BaseURL),
        {
          ...
          params: new HttpParams().set('search[Tabla]', Tabla).set('search[IdTabla]', IdTabla.toString())
        }
      )
      .pipe(
  ...
  update() {
    ...
    return this.httpClient
      .put<any>(
        this.CONSTANS.getApiUrl(this.BaseURL + 'update/' + this.form.value.Id),
        this.form.value,
        { headers: this.CONSTANS.getApiHeaders(this.authService.getToken()) }
      )
      .pipe(
  ...
  delete() {
    ...
    return this.httpClient
      .delete<any>(
        this.CONSTANS.getApiUrl(this.BaseURL + 'delete/' + this.form.value.IdTraduccion),
        { headers: this.CONSTANS.getApiHeaders(this.authService.getToken()) }
      )
      .pipe(
        finalize(() => this.loadingSubject.next(false)),
