...
@Component({
  ...
  styleUrls: ['./tipo-entidad.component.less']
})
export class TipoEntidadComponent implements OnInit {
   ...
   Array: Roles[] = [
    ...
    {id:3,nombre:'Poblacion'}
  ]; 
  //DataTable --
  displayedColumns: string[] = ['id', 'nombre','commands',];
  dataSource = new MatTableDataSource<Roles>(this.Array);
 ...
 this.paginator._intl.itemsPerPageLabel="Registros por página";
  ...
  guardarClick(event: Event) {
    ...
    if(this.transaccionIsNew)
    {
      ...
      this.dataSource = new MatTableDataSource<Roles>(this.Array);
      this.dataSource.paginator = this.paginator;
      this.nombre ="";
    }
    else{
